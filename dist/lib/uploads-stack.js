...
class UploadsStack extends cdk.Stack {
...
def handler(event, context):
    try:
      ...
      `),
        ...
        const authorizer = new apigateway.CognitoUserPoolsAuthorizer(this, "UploadsAuthorizer", { cognitoUserPools: [props.userPool] });
        const withAuth = (fn) => ({
...
exports.UploadsStack = UploadsStack;
